...
const SvgProgress = () => {
  ...
  useEffect(()=>{
      ...
      gsap.to('.transrg',{drawSVG:"0 10",duration:1,strokeWidth:5,stroke:"red"},{scrollTrigger:{trigger:"svg",scrub:true}});
      gsap.to('.transrgwht',{drawSVG:0,duration:1,strokeWidth:2,stroke:"white"},{scrollTrigger:{trigger:"svg",scrub:true}});
  ...
  return (
    <div className="progress">
       <div className='circle'>
          <div id='svg' className='svgContainer'>
